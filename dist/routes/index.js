...
router.patch("/skills/:id", isAuthenticated, upload.single("icon"), updateSkill);
router.delete("/skills/:id", isAuthenticated, deleteSkill);
/*________________ Projects ______________*/
router.get("/projects", getProjects);
router.get("/projects/:id", getProjectById);
router.post("/projects", isAuthenticated, upload.single("image"), createProject);
router.patch("/projects/:id", isAuthenticated, upload.single("image"), updateProject);
